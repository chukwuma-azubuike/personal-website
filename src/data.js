const data = {
    ...
    experience: {
        ...
        entries: [
            ...
            {
                companyLogo: 'https://i.ibb.co/7tKSWSn/GE-logo.png',
                companyName: 'GE Oil and Gas',
                role: 'Project Management Intern',
                jobDescription: '',
                responsibilities: [
                    'Assisted in managing contractual and maintenance services for turbo-machinery installed in sub Saharan Africa',
                    'Planned and scheduled maintenance',
                    'Followed up on customers to ensure prompt and accurate payment'
                ],
                accomplishments: [],
